                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="edit/{{$category->id}}" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="id" name="id" disabled="true" value="{{$category->id}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="price" name="description" value="{{$category->description}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-skill" name="status">
                                                    ...
                                                    <option value="0" {{$category->status ?: "selected='true'"}}>Inactive</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
