                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-validate" action="/admin/user/create" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <img id="image-hint" style="max-height: 100px" src="{{asset('images/users/user-default.png')}}">
